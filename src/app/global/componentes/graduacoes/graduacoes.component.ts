...
export class GraduacoesComponent {
  ...
  src_3 = 'assets/fotos/c1.png'
  topico_3 = [
    'Roxo-Marrom',
    'Em estágio',
  ];
  //
  src_4 = 'assets/fotos/c1.png'
  topico_4 = [
    'Roxo',
    'Um Aluno graduado procura do que é ser mestre de capoeira',
  ];

  src_5 = 'assets/fotos/c1.png'
  topico_5 = [
    'Azul-Roxo',
    'Em estágio',
  ];
  //
  src_6 = 'assets/fotos/c1.png'
  topico_6 = [
    'Azul',
    'Encontrar uma descriçao',
  ];
  //
  src_7 = 'assets/fotos/c1.png'
  topico_7 = [
    'Verde-Azul',
    'Em estágio',
  ];
  src_8 = 'assets/fotos/c1.png'
  topico_8 = [
    'Verde',
    'Encontrar uma descriçao',
  ];

  src_9 = 'assets/fotos/c1.png'
  topico_9 = [
    'Laranja-Verde',
    'Em estágio',
  ];

  src_10 = 'assets/fotos/c1.png'
  topico_10 = [
    'Laranja',
    'Em estágio',
  ];

  src_11 = 'assets/fotos/c1.png'
  topico_11 = [
    'Amarela-Laranja',
    'Encontrar uma descriçao',
  ];

  src_12 = 'assets/fotos/c1.png'
  topico_12 = [
    'Amarela',
    'Em estágio',
  ];

  src_13 = 'assets/fotos/c1.png'
  topico_13 = [
    'Cinza-Amarela',
    'Encontrar uma descriçao',
  ];

  src_14 = 'assets/fotos/c1.png'
  topico_14 = [
    'Cinza',
  ...
  src_20 = 'assets/fotos/c1.png';
  topico_20 = [
    'Ponta Marrom',
    'Encontrar uma descriçao'
  ]

  src_21 = 'assets/fotos/c1.png';
  topico_21 = [
    'Ponta Marrom-Roxo',
    'Em estágio'
  ]
  ...
  src_29 = 'assets/fotos/c1.png';
  topico_29 = [
    'Ponta Amarela-Laranja',
    'Em estágio'
  ]

  src_30 = 'assets/fotos/c1.png';
  topico_30 = [
    'Ponta Amarela',
    'Encontrar uma descriçao'
  ]
  src_31 = 'assets/fotos/c1.png';
  topico_31 = [
    'Ponta Cinza',
    'Encontrar uma descriçao'
  ]

  src_40 = 'assets/fotos/c1.png';
  topico_40 = [
    'Crua Marrom ',
    'Encontrar uma descriçao'
  ]
  src_41 = 'assets/fotos/c1.png';
  topico_41 = [
    'Crua Roxa ',
    'Encontrar uma descriçao'
  ]
  src_42 = 'assets/fotos/c1.png';
  topico_42 = [
    'Crua Azul ',
    'Encontrar uma descriçao'
  ]

  src_43 = 'assets/fotos/c1.png';
  topico_43 = [
    'Crua Verde ',
    'Encontrar uma descriçao'
  ]

  src_44 = 'assets/fotos/c1.png';
  topico_44 = [
    'Crua Laranja ',
    'Encontrar uma descriçao'
  ]
  src_45 = 'assets/fotos/c1.png';
  topico_45 = [
    'Crua Amarela ',
    'Encontrar uma descriçao'
  ]
  src_46 = 'assets/fotos/c1.png';
  topico_46 = [
    'Crua Cinza ',
    'Encontrar uma descriçao'
  ]
